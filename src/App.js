    ...
    <div className="container">
      ...
      <main className="main">
        ...
        <Switch>
          <Route
            path="/characters"
            render={() => <CharactersScreen favorites={favorites} />}
          />
          <Route
            path="/character/:id"
            render={() => <CharacterScreen favorites={favorites} />}
          />
          <Route
            path="/favorites"
            render={() => (
    ...
    <nav className="nav card">
      <ul className="nav__list">
        <li className="nav__item">
          <NavLink className="nav__link nav__link--active" to="/favorites">
            Favorites
          </NavLink>
        </li>

        <li className="nav__item">
          <NavLink className="nav__link" to="/characters">
            Characters
          </NavLink>
        </li>
      </ul>
